...
public class DefaultDatabaseSchemaDriver implements IDatabaseSchemaDriver
{
            ...
            ) throws SQLException
    {
        ...
        try
        {
            final String createPK = "ALTER TABLE " + tablePart + " ADD CONSTRAINT " + constraintName + " PRIMARY KEY(" + columnPart + ") INDEX " + indexName + " " + tableSpaceDefinition;
            ...
            ) throws SQLException
    {
        ...
        try
        {
            final String createPK = "ALTER TABLE " + tablePart + " ADD CONSTRAINT " + constraintName + " PRIMARY KEY(" + columnPart + ") " + tableSpaceDefinition;
            createPKStatement = connection.prepareStatement(createPK);
            createPKStatement.executeUpdate();
        }
        finally
            ...
            ) throws SQLException
    {
        ...
        if(columnProperties.get("INVALID_NULLABLE") != null)
        {
            ...
            try
            {
                final String nullableStatement = "ALTER TABLE  " + tablePart + " ALTER COLUMN " + columnPart + " SET " + (nullable ? "" : "NOT") + " NULL";
            ...
            throws SQLException
    {
        ...
        try
        {
            final String createFK = "ALTER TABLE  " + tablePart + " ADD CONSTRAINT " + constraintPart + " FOREIGN KEY (" + columnPart + ") REFERENCES "
            ...
            throws SQLException
    {
        ...
        try
        {
            createColumnStatement = connection.prepareStatement("DROP INDEX " + schema + "." + indexPart + " ");
            createColumnStatement.executeUpdate();
        }
        finally
        {
    ...
    public boolean schemaExists(final Connection connection, final String schemaName) throws SQLException
    {
        ...
        final ResultSet resultSet = meta.getSchemas();
        while (resultSet.next())
        {
